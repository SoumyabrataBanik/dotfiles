...
return {
	...
	config = function()
		...
		vim.keymap.set("n", "<Space>x", vim.cmd.BufferClose, { desc = "Close current buffer" })
		vim.keymap.set("n", "<C-z>", vim.cmd.BufferPrevious, { desc = "Move to previous buffer" })
		vim.keymap.set("n", "<C-x>", vim.cmd.BufferNext, { desc = "Move to next buffer" })
